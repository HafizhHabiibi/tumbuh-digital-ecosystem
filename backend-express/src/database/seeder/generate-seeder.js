...
async function generateSeeder() {
    ...
    for (const data of accounts.kader) {
        ...
        lines.push(
            `VALUES ('${userId}', '${data.email}', '${hash}', 'kader', TRUE);`,
        );
        lines.push("");
        lines.push(`INSERT INTO kader (id, user_id, nama_lengkap, no_hp)`);
        lines.push(
            `VALUES ('${kaderId}', '${userId}', '${data.nama_lengkap}', '${data.no_hp}');`,
        );
        lines.push("");
    }
    ...
    for (const data of accounts.puskesmas) {
        ...
        lines.push(
            `VALUES ('${userId}', '${data.email}', '${hash}', 'puskesmas', TRUE);`,
        );
        lines.push("");
        lines.push(
        ...
        lines.push(
            `VALUES ('${puskesmasId}', '${userId}', '${data.nama_lengkap}', '${data.jabatan}', '${data.no_hp}');`,
        );
        lines.push("");
    }
