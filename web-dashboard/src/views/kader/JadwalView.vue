    ...
    <div class="p-4 sm:p-5 md:p-6 w-full max-w-6xl mx-auto space-y-5 min-w-0">
        ...
        >
            <div v-if="jadwalDipilihHapus" class="space-y-4 pt-2">
                ...
                <div
                    v-if="jadwalStore.error.delete"
                    class="flex items-start gap-2.5 p-3 rounded-xl bg-red-50 border border-red-200 text-xs text-red-700"
                    role="alert"
                >
                    <i class="pi pi-exclamation-circle mt-0.5 shrink-0" aria-hidden="true" />
                    <span>{{ jadwalStore.error.delete }}</span>
                </div>
